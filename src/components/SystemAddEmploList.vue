    ...
    methods: {
        changeLanguage() {
            if (this.langValue === 'en') {
                ...
                this.positionPHStr = 'Please select position';
                this.levelStr = 'Level';
                ...
                this.positionStr = '職名';
                this.positionPHStr = '職名を選択してください';
                this.levelStr = '職級';
        ...
        addInfo() {
            ...
            if (this.position === "default") {
                if (this.langValue === 'ch') {
                    ...
                    this.message = "Please select the position.";
                } else if (this.langValue === 'jp') {
                    this.message = "職名欄を選択してください。";
                }
                error = true;
                if (error) {
                    this.errorPopup();
        ...
        <div class="add">
            ...
            <div class="area1">
                ...
                <div class="info">
                    ...
                    <input :style="{ backgroundColor: isInputInvalid === 1 ? 'rgb(238, 198, 198)' : '' }" maxlength="20"
                        @input="checkInputLegth('employeeId')" ref="employeeId" v-model="id" id="employeeId"
                        :placeholder="employeeIdPHStr" type="text">
                    <!-- 姓名輸入 -->
                    <label for="name">{{ nameStr }}*</label>
                    <input :style="{ backgroundColor: isInputInvalid === 2 ? 'rgb(238, 198, 198)' : '' }" maxlength="20"
                        @input="checkInputLegth('name')" ref="name" v-model="name" id="setName" :placeholder="namePHStr"
                        type="text">
                    ...
                    <input :style="{ backgroundColor: isInputInvalid === 3 ? 'rgb(238, 198, 198)' : '' }"
                        @input="checkInputLegth('email')" ref="email" v-model="email" id="setEmail"
                        :placeholder="emailPHStr" type="text">
                    <!-- 電話輸入 -->
                    <label for="">{{ phoneStr }}*</label>
                    <input :style="{ backgroundColor: isInputInvalid === 6 ? 'rgb(238, 198, 198)' : '' }" maxlength="10"
                        @input="checkInputLegth('phone')" ref="phone" v-model="phone" id="setPhone"
                        :placeholder="phonePHStr" type="text">
                </div>
                <!-- 右側填寫區 -->
                <div class="detail">
                    ...
                    <select ref="department" v-model="department" id="setDepartment">
                        ...
                        <option v-else-if="langValue === 'en'" value="default" selected>Please choose your department
                        </option>
                    ...
                    <select v-model="position">
                        <option value="default" selected>{{ positionPHStr }}</option>
                    ...
                    <input maxlength="20" @input="checkInputLegth('supervisor')" ref="supervisor" v-model="supervisor"
                        id="supervisorId" :placeholder="supervisorPHStr" type="text">
